...
public class RowFilter   {
	...
	public static final Log LOG = LogFactory.getLog(RowFilter.class.getName());
    ...
    private RowFilterTree rowFilter=  null;
...
//    private IndexFilterTree rowFilter = null;
    ...
    public RowFilter(String sql  , FileSystem fs)
    {
    	this.sql = sql;
    	this.fs = fs;
        ...
        try {
			...
			String appName  = tree.getChild(1).getChild(0).getText();
	    	  ...
	    	  * 识别文本还是二进制
	    	  */
	    	 rp = ReadData.getBinaryReadData(tableName, appName, fs);
	    	 
	    	 //rp = ReadData.getTextReadData(tableName, appName, fs);
	    	 
	    	 
	    	 
	    	 rowFilter = new RowFilterTree((CommonTree)tree.getChild(3), rp);
